    ...
    <div className={styles.about}>
      ...
      <div className={styles.text}>
        ...
        <p className={styles.description}>
          I&apos;m Daksh, a full-stack developer with a passion for building products to improve the lives of those
          around me. I&apos;m currently pursuing a degree in Computer Science as a 2nd year student at the University of
          the Fraser Valley.
        </p>
        <p className={styles.description}>
          I&apos;m passionate about harnessing my skills to empower others and create positive impacts in the community.
          This passion shines through in my personal projects as well as in the hackathons.
        </p>
        <p className={styles.description}>
